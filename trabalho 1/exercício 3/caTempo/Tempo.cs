...
namespace caTempo
{
    class Tempo
    {
        ...
        public void askHour(int i)
        {
            do
            {
                Console.WriteLine("Insira a hora do t"+ i +" corretamente: ");
                hora = Convert.ToInt32(Console.ReadLine());
            } while (hora < 0 || hora > 23);

            do
            {
                Console.WriteLine("Insira os minutos do t" + i + " corretamente: ");
                min = Convert.ToInt32(Console.ReadLine());
            } while (min < 0 || min > 59);

            do
            {
                Console.WriteLine("Insira os segundos do t" + i + " corretamente: ");
        ...
        {
            Console.WriteLine("A hora t" + t + " é: "+ hora +":"+ min + ":" + segs);
        }
